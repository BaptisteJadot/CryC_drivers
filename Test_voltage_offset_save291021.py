# -*- coding: utf-8 -*-
"""
Created on Fri Oct 29 10:39:04 2021
...
for i in range(32+8): # write value to all + loop to addr 15
...
Vramp = np.linspace(0.5, 1.5, 101)
for Vi in Vramp:
    # seq += [fs.Panel4(clk=False, even_value=Vi, odd_value=0.5)]
    seq += [fs.Panel4(clk=False, even_value=0.5, odd_value=Vi)]
